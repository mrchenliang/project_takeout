const dbHelpers = {
  ...
  getMenuItems: function(db, restId) {
    ...
    return db
      .query(
        `SELECT menu_items.*, categories.name as category_name, restaurants.name as restaurant_name, restaurants.phone as restaurant_phone, restaurants.website as restaurant_website, restaurants.address as restaurant_address, restaurants.cover_photo_url as restaurants_image_url
